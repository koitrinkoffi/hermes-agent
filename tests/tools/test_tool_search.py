...
class TestClassification:
    def test_core_tools_never_defer(self):
        ...
        # session_search is deliberately NOT pinned on this install (cross-
        # session recall is Hindsight's job here) -- see the toolsets.py
        # header comment. Dropped from the sample rather than re-pinned.
